...
COPY docker/ensure-jwt-keys.sh /usr/local/bin/ensure-jwt-keys.sh
...
RUN sed -i 's/\r$//' /usr/local/bin/entrypoint.sh /usr/local/bin/release.sh /usr/local/bin/ensure-jwt-keys.sh /usr/local/bin/start-web.sh \
    && chmod +x /usr/local/bin/entrypoint.sh /usr/local/bin/release.sh /usr/local/bin/ensure-jwt-keys.sh /usr/local/bin/start-web.sh
